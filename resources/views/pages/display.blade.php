...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="flex justify-between">
            <h1 class="text-3xl text-white font-bold text-gray-800">Data Overview</h1>
        ...
        <div class="mt-8 bg-primary border rounded border-orange shadow-2xl shadow-black text-white p-12">
            <div class="flex flex-wrap -mb-4">
                <h2 class="text-3xl mb-6 text-gray-700">Overview of Training Completion - Task One</h2>
                <table class="w-full table-auto rounded shadow-lg">
        ...
        <div class="border-t border-white mt-16"></div>

        <div class="bg-gray-100 py-6 mt-8">
            <div class="container mx-auto px-6">
                <h2 class="text-3xl mb-6 text-white">Completion Record for Trainings - Task Two</h2>
                <div class="flex flex-wrap items-start justify-start mt-8">
                    @foreach ($participants as $training)
                        <div class="p-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4">
                            <div class="h-full bg-primary border border-orange text-white rounded shadow-2xl">
                                <div class="p-6">
        ...
        <div class="bg-primary border border-orange shadow-2xl rounded py-6 mt-8">
            <div class="container mx-auto px-6">
                <h2 class="text-3xl mb-6 text-white">Training Expiry Status For Individuals - Task Three</h2>
                <div class="flex flex-wrap justify-start mt-8">
                    @foreach ($peopleWithExpiredTrainings as $person)
                        <div class="p-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4">
                            <div class="h-full bg-primary-80 border border-orange text-white rounded">
                                <div class="p-6">
                                    <h2 class="text-2xl font-bold leading-7 text-gray-800 sm:text-3xl sm:truncate">
                                        {{ $person['name']}}
                                    </h2>
